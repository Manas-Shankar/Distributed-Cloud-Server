...
#ifndef GRPC_backend_5fmaster_5fas_5fclient_2eproto__INCLUDED
#define GRPC_backend_5fmaster_5fas_5fclient_2eproto__INCLUDED
...
class BackendMasterClientService final {
 public:
  static constexpr char const* service_full_name() {
    return "backendmaster.BackendMasterClientService";
  }
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status CheckHealth(::grpc::ClientContext* context, const ::kvstore::HealthCheckRequest& request, ::kvstore::HealthCheckResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::kvstore::HealthCheckResponse>> AsyncCheckHealth(::grpc::ClientContext* context, const ::kvstore::HealthCheckRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::kvstore::HealthCheckResponse>>(AsyncCheckHealthRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::kvstore::HealthCheckResponse>> PrepareAsyncCheckHealth(::grpc::ClientContext* context, const ::kvstore::HealthCheckRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::kvstore::HealthCheckResponse>>(PrepareAsyncCheckHealthRaw(context, request, cq));
    }
    ...
    class async_interface {
     public:
      ...
      virtual void CheckHealth(::grpc::ClientContext* context, const ::kvstore::HealthCheckRequest* request, ::kvstore::HealthCheckResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void CheckHealth(::grpc::ClientContext* context, const ::kvstore::HealthCheckRequest* request, ::kvstore::HealthCheckResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
   ...
   private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::kvstore::HealthCheckResponse>* AsyncCheckHealthRaw(::grpc::ClientContext* context, const ::kvstore::HealthCheckRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::kvstore::HealthCheckResponse>* PrepareAsyncCheckHealthRaw(::grpc::ClientContext* context, const ::kvstore::HealthCheckRequest& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status CheckHealth(::grpc::ClientContext* context, const ::kvstore::HealthCheckRequest& request, ::kvstore::HealthCheckResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::kvstore::HealthCheckResponse>> AsyncCheckHealth(::grpc::ClientContext* context, const ::kvstore::HealthCheckRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::kvstore::HealthCheckResponse>>(AsyncCheckHealthRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::kvstore::HealthCheckResponse>> PrepareAsyncCheckHealth(::grpc::ClientContext* context, const ::kvstore::HealthCheckRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::kvstore::HealthCheckResponse>>(PrepareAsyncCheckHealthRaw(context, request, cq));
    }
    ...
    class async final :
     ...
     public:
      ...
      void CheckHealth(::grpc::ClientContext* context, const ::kvstore::HealthCheckRequest* request, ::kvstore::HealthCheckResponse* response, std::function<void(::grpc::Status)>) override;
      void CheckHealth(::grpc::ClientContext* context, const ::kvstore::HealthCheckRequest* request, ::kvstore::HealthCheckResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::kvstore::HealthCheckResponse>* AsyncCheckHealthRaw(::grpc::ClientContext* context, const ::kvstore::HealthCheckRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::kvstore::HealthCheckResponse>* PrepareAsyncCheckHealthRaw(::grpc::ClientContext* context, const ::kvstore::HealthCheckRequest& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status CheckHealth(::grpc::ServerContext* context, const ::kvstore::HealthCheckRequest* request, ::kvstore::HealthCheckResponse* response);
  ...
  class WithAsyncMethod_CheckHealth : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status CheckHealth(::grpc::ServerContext* /*context*/, const ::kvstore::HealthCheckRequest* /*request*/, ::kvstore::HealthCheckResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestCheckHealth(::grpc::ServerContext* context, ::kvstore::HealthCheckRequest* request, ::grpc::ServerAsyncResponseWriter< ::kvstore::HealthCheckResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  typedef WithAsyncMethod_Shutdown<WithAsyncMethod_Restart<WithAsyncMethod_CheckHealth<WithAsyncMethod_SetPrimary<WithAsyncMethod_ActiveNodes<Service > > > > > AsyncService;
  template <class BaseClass>
    ...
    WithCallbackMethod_CheckHealth() {
      ::grpc::Service::MarkMethodCallback(2,
          new ::grpc::internal::CallbackUnaryHandler< ::kvstore::HealthCheckRequest, ::kvstore::HealthCheckResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::kvstore::HealthCheckRequest* request, ::kvstore::HealthCheckResponse* response) { return this->CheckHealth(context, request, response); }));}
  ...
  typedef WithCallbackMethod_Shutdown<WithCallbackMethod_Restart<WithCallbackMethod_CheckHealth<WithCallbackMethod_SetPrimary<WithCallbackMethod_ActiveNodes<Service > > > > > CallbackService;
  ...
  class WithStreamedUnaryMethod_CheckHealth : public BaseClass {
   ...
   public:
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedCheckHealth(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::kvstore::HealthCheckRequest,::kvstore::HealthCheckResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_Shutdown<WithStreamedUnaryMethod_Restart<WithStreamedUnaryMethod_CheckHealth<WithStreamedUnaryMethod_SetPrimary<WithStreamedUnaryMethod_ActiveNodes<Service > > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_Shutdown<WithStreamedUnaryMethod_Restart<WithStreamedUnaryMethod_CheckHealth<WithStreamedUnaryMethod_SetPrimary<WithStreamedUnaryMethod_ActiveNodes<Service > > > > > StreamedService;
};

}  // namespace backendmaster


#endif  // GRPC_backend_5fmaster_5fas_5fclient_2eproto__INCLUDED
