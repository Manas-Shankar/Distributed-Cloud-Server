...
const ::_pbi::TcParseTable<2, 3, 0, 41, 2> PutRequest::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<2, 4, 0, 43, 2> CPutRequest::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
...
::uint8_t* CPutRequest::_InternalSerialize(
  ...
  if (!this->_internal_value2().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "kvstore.CPutRequest.value2");
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<0, 1, 0, 33, 2> GetResponse::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    1, 0,  // max_field_number, fast_idx_mask
